...
import ejb.stateful.RemoteCounter;
import ejb.stateless.RemoteCalculator;
...
public class RemoteEJBClient {
    ...
    private static RemoteCalculator lookupRemoteStatelessCalculator() throws NamingException {
        ...
        // let's do the lookup
        return (RemoteCalculator) context.lookup("ejb:/WMS/CalculatorBean!"
                + RemoteCalculator.class.getName());
        //return (RemoteCalculator) context.lookup("java:global/ejb-remote/CalculatorBean!ejb.stateless.RemoteCalculator");
    }
    ...
    private static RemoteCounter lookupRemoteStatefulCounter() throws NamingException {
        ...
        // let's do the lookup
        return (RemoteCounter) context.lookup("ejb:/WMS//CalculatorBean!"
